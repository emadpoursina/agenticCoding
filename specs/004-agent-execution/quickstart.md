...
1. A temp methodology (copy `tests/fixtures/ainative-full/`, whose current agent root is `docs/agents/` and includes fixture `scout`, `tester`, `specs-planner`, and `builder`).
